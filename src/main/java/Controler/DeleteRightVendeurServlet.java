...
@WebServlet(name = "DeleteRightVendeurServlet", value = "/deleteRightVendeur-servlet")
public class DeleteRightVendeurServlet extends HttpServlet{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if(idVendeur != 0 && right != null && !right.isEmpty()){
                ...
                request.setAttribute("errRemoveRight", "Erreur");
